          ...
          <div class="tabs">
            <div class="border-b tab">
              <div class="border-l-2 border-transparent relative">
                ...
                />
                <header
                  class="flex justify-between items-center w-full py-1 cursor-pointer select-none tab-label bg-white card rounded-lg"
                  for="chck1"
                >
                ...
                <div class="tab-content">
                  <div class="pl-8 pr-8 pb-5 text-grey-darkest">
                    <ul class="pl-4">
                      ...
                      <li class="pb-2">Viverra orci sagittis eu volutpat odio facilisis mauris</li>
                    </ul>
                  </div>
                </div>
              </div>
